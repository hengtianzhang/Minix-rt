...
#define atomic64_andnot(i, v)		atomic64_and(~(s64)(i), (v))
#endif

#ifndef atomic64_fetch_andnot_relaxed

#ifndef atomic64_fetch_andnot
#define atomic64_fetch_andnot(i, v)		atomic64_fetch_and(~(s64)(i), (v))
#define atomic64_fetch_andnot_relaxed(i, v)	atomic64_fetch_and_relaxed(~(s64)(i), (v))
#define atomic64_fetch_andnot_acquire(i, v)	atomic64_fetch_and_acquire(~(s64)(i), (v))
#define atomic64_fetch_andnot_release(i, v)	atomic64_fetch_and_release(~(s64)(i), (v))
...
static inline s64 atomic64_fetch_add_unless(atomic64_t *v, s64 a,
						  s64 u)
{
...
#include <asm-generic/misc/atomic-long.h>
